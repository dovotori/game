export default class {
  ...
  setupNodes() {
    ...
    for (var i = 0; i < this.points.length; i += 2, cptNodes++) {
      ...
      this.nodes[cptNodes].setPosition(
        this.pointsReference[i],
        this.pointsReference[i + 1],
        0,
      )
    }
  }
  ...
  drawPoints() {
    ...
    for (var i = 0; i < this.points.length; i += 2, cptNodes++) {
      ...
      context.lineTo(
        this.nodes[cptNodes].position.x,
        this.nodes[cptNodes].position.y,
      )
      context.stroke()
    }
  }
